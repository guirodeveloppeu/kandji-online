...
const cars = [
	{
		...
		image: lathaye,
		description:
			"Un chef-d'œuvre d'ingénierie se caractérisant par une puissance inébranlable, des fonctionnalités à la pointe et un confort opulent.",
	},
	{
		id: 1,
	...
	},
	{
		...
		image: soura,
		description:
			"Voiture SUV manuelle très pratique pour vos déplacements. Elle a un puissant moteur de 1600 cc. Elle offre une moyenne de 14 km par litre.",
	},
	{
		id: 9,
		name: "KPANDJI RL9",
	...
	{
		id: 4,
		name: "KPANDJI BUS Electric",
		int1: busint1,
		int2: busint2,
		image: buse,
		description:
			"C'est un bus Electrique de 12m de long, spécialement développé et conçu pour s'adapter aux lignes principales urbaines. ",
	},
	{
		id: 3,
		name: "SWASRAN MINI",
		...
		image: swansran,
		description:
			"Minibus électrique de luxe de 14 places. le véhicule peut être converti en véhicules spéciaux tels qu'une ambulance, ",
	},

	{
		id: 10,
		name: "KPANDJI SWASRAN",
		int1: swasranint1,
		int2: swasranint2,
		image: swasran,
		description:
			"Minibus électrique à grande vitesse à toit surélevé, nouvelle fourgonnette Haice, autonomie et atteint 260 km",
	},
	{
		id: 11,
		name: "SWATRO 1",
		...
		image: swatro1,
		description:
			"Mini camion de grande capacité et de haute sécurité  à essence et atteind une capacité de 1,5 tonne.",
	},
	{
		id: 11,
		name: "SWATRO 2",
		...
		image: swatro2,
		description:
			" C'est un camion qui fait sensation depuis son lancement en étant reconnu comme un chef-d'œuvre par ses opérateurs et l'industrie du fret.",
	},
...
const Globals = () => {
	...
	return (
		<div className="flex flex-col mx-auto px-4 mb-10">
